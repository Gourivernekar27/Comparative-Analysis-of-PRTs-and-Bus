...
pod_files = [
    "processed_392_pod.csv",
    "processed_896_pod.csv",
    "processed_2968_pod.csv",
    "processed_4032_pod.csv",
    "processed_5040_pod.csv",
    "processed_7952_pod.csv",
]

# Pod-optimized file names
pod_opt_files = [
    "processed_Excel392[1]_allocations_trial2.csv",
    "processed_Excel896[1]_allocations_trial2.csv",
    "processed_Excel2968[1]_allocations_trial2.csv",
    "processed_Excel4032[1]_allocations_trial2.csv",
    "processed_Excel5040[1]_allocations_trial2.csv",  # Removed file:// prefix
    "processed_Excel7952[1]_allocations_trial2.csv",
]
